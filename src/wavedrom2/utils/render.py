...
def text_width(string: str, size: int = 11) -> float:
    ...
    Args:
        string (str): The text string to measure.
        size (int, optional): The font size. Defaults to 11.

    Returns:
        float: The width of the text string in pixels.
    """
    # * Note: This array comes from the original. Not sure where the values came from.
    chars = [
        0,
        0,
        0,
